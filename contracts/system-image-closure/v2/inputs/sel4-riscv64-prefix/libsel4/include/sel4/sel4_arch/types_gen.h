/* generated from /Users/iceice666/code/slime_os/deps/sel4/libsel4/sel4_arch_include/riscv64/sel4/sel4_arch/types.bf */
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_RA(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A0(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A1(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A2(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A3(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A4(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A5(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UnknownSyscall_ptr_set_A6(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UnknownSyscall);
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UserException_ptr_set_SP(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 v64) {
    /* fail if union does not have the expected tag */
    seL4_DebugAssert(((seL4_Fault_ptr->words[0] >> 0) & 0xf) == seL4_Fault_UserException);

...
pub use syscall::{
    ...
    MAX_CAPS_PER_MSG, MAX_DIRECTORY_PATH, MAX_MSG, Rights, SharedBuffer, SpawnGrant, Termination,
    block_transact, block_transact_sector, block_transact_write, call, cap_drop,
    capability_delegate, capability_import, debug_write, directory_commit, directory_derive,
    directory_inspect, exit, input_read, notification_poll, notification_signal, notification_wait,
    recv, recv_blocking, reply, send, shared_buffer_create, shared_buffer_loan,

...
pub use syscall::{
    ...
    MAX_CAPS_PER_MSG, MAX_MSG, SpawnGrant, Spawned, Termination, block_transact, cap_drop,
    debug_write, endpoint_create, exit, health_confirm, recovery_reconstruct, recv, send, spawn,

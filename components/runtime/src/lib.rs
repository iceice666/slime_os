...
pub use syscall::{
    ...
    PARAMETER_SELF_SLOT, PrivateMemory, RestartAdmission, Rights, SchedulingClassInfo,
    ...
    lifecycle_parameter_read, lifecycle_parameter_write, lifecycle_restart_admit,
    lifecycle_state_advance, lifecycle_state_read, monotonic_read, notification_poll,

...
P2.1 complete; P2.2–P2.6 superseded by [P5](../../roadmap/07-architecture-portability.md#p5-sel4-microkernel-substitution), which supplies the same mechanisms from upstream seL4 instead of a hand-written AArch64 kernel. Their deliverables below are retained as the record of what the custom-kernel route required, not as open work.

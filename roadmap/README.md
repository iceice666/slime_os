...
| --- | --- | --- |
| [Backlog](00-backlog.md) | B1–B69 resolved; **B70 open** (component definitions and slot/route bindings are compile-time-coupled to one crate's private manifest parser) — CP0 landed its specification half | B70's remaining halves are CP1 (generation derivation) and CP2 (runtime binding resolution) in the [Component platform track](10-component-platform.md); B61/B63/B65 each record a deliberately deferred half a future audit should start from |
...
| [Component platform](10-component-platform.md) | CP0 complete (`contracts/component-spec/v1`, 42 records, `just component_spec_check`); CP1–CP5 not started | CP2 (runtime binding resolution) has no dependency and can start immediately; CP1 now has its CP0 prerequisite |

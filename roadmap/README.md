...
- **Core lane:** the C7 backlog is clear; C8.1–C8.4 have landed, so C8.5 reliable, retained, and timed QoS is the next open slice. C10 private component memory is planned and independent of C8/C9, but waits on B9.

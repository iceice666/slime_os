...
| [Architecture portability](07-architecture-portability.md) | P0, P1, P2.1, P2.2, P3, P3.D, P3.E, and P5 complete; P2.3–P2.6 superseded by P5. The named Milk-V Duo physically boots upstream seL4 and a target-qualified generation, runs the architecture-neutral sample plane with repeatable normalized evidence, proves timer/fault behavior, and recovers autonomously | P3.F is the next Duo follow-up: boot the resident product graph and drive a capability-bounded Slisp session over the board's serial path. Storage, USB, network, display, sensor, and actuator qualification remain separate future scope; P4/RP3 and Framework retain their named physical blockers |

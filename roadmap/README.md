...
| --- | --- | --- |
| [Backlog](00-backlog.md) | B1–B69 and B71–B76 resolved; **B70 open** (component definitions and slot/route bindings are compile-time-coupled to one crate's private manifest parser) — CP0/CP1 landed the specification and derivation halves and CP2 landed the query itself. B75 closed 2026-08-20 by separating the trace fields a composition declares from those a run observes | B70's remaining half is CP2's migration (runtime binding resolution) in the [Component platform track](10-component-platform.md); B61/B63/B65 each record a deliberately deferred half a future audit should start from |
...
| [Component platform](10-component-platform.md) | CP0 and CP1 complete; CP2's root-served binding query is landed, documented and gated, resolving both manifest grants and namespaced boot-layout roles; CP3–CP5 not started | The remaining CP2 sites are `fabric_profile`'s, where 46 of 64 constants are graph facts rather than slots and belong to the `fabric-graph` resource instead |

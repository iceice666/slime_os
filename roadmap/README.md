...
| [Architecture portability](07-architecture-portability.md) | P0, P1, P2.1, P5.1, P5.2, and P5.3.1 complete; P2.2-P2.6 superseded-if-P5-completes; P5.3.2-P5.3.4, P5.4, and P5.5 planned | Begin P5.3.2: serve the loan plane on seL4 against quotas decoded from the generation rather than a hardcoded constant |

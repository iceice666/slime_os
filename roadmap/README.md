...
| --- | --- | --- |
| [Backlog](00-backlog.md) | B1–B11, B13–B15, B18, and B19 resolved; B12, B16, B17, and B20 open, all deferred with reason | Resolve B12, B16, B17, and B20 before the next track gate, or record why they stay deferred |
...
| [Architecture portability](07-architecture-portability.md) | P0, P1, P2.1, P5.1, P5.2, all of P5.3, and all of P5.5 complete; P2.2-P2.6 superseded-if-P5-completes; P5.4 planned | Begin P5.4: retire the custom kernel, once every acceptance check it guards has an observed seL4 equivalent |

...
| [Architecture portability](07-architecture-portability.md) | P0, P1, P2.1, P5.1, P5.2, all of P5.3, and all of P5.5 complete; P2.2-P2.6 superseded-if-P5-completes; P5.4 planned | Resolve B18 (the stream gate passes ~1 run in 3), then begin P5.4: retire the custom kernel |

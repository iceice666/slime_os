...
| [Core runtime](02-core-runtime.md) | C7 in progress; C7.1–C7.2 complete (generation v3 + `u64` rights; shared-buffer factory allocation) | Land C7.3 generation quotas and supervision-subtree accounting |

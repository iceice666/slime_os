...
| [Core runtime](02-core-runtime.md) | C7 in progress; C7.1–C7.3 complete (generation v3 + `u64` rights; shared-buffer factory allocation; per-holder quotas + supervision-subtree accounting) | Land C7.4 shared-buffer mapping and read-only sealing |

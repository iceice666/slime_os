...
| --- | --- | --- |
| [Backlog](00-backlog.md) | B1–B69 resolved; **B70 open** (component definitions and slot/route bindings are compile-time-coupled to one crate's private manifest parser) — CP0/CP1 landed the specification and derivation halves and CP2 landed the query itself | B70's remaining half is CP2's migration (runtime binding resolution) in the [Component platform track](10-component-platform.md); B61/B63/B65 each record a deliberately deferred half a future audit should start from |
...
| [Component platform](10-component-platform.md) | CP0 and CP1 complete; CP2's root-served binding query is landed, documented and gated, with 2 of 19 `include!` sites migrated and the rest blocked on a `contracts/boot-layout/v1` format change; CP3–CP5 not started | Give boot-layout entries an owning instance so `init`'s 61 slots become runtime-resolvable, which unblocks the remaining CP2 sites |

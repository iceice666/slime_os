...
pub mod interrupts {
    ...
    /// exception vectors and GIC interrupt IDs rather than an IDT; P2.2 fixes
    /// the concrete numbering.
    ...
    pub fn init() {
        unimplemented!("aarch64 exception vectors: implemented by P2.2")
    }
}

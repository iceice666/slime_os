...
//!
//! P2.3 implements the `eret` path — restoring `x0`–`x30`, `SP_EL0`, `ELR_EL1`,
//! and `SPSR_EL1`, and installing the incoming `TTBR0_EL1` — behind this
//! signature. It depends on the exception vectors P2.2 installs.
...
pub unsafe fn switch_address_space_and_user(_root: u64, _frame: *const UserFrame) -> ! {
    unimplemented!("aarch64 eret to EL0: implemented by P2.3")
}

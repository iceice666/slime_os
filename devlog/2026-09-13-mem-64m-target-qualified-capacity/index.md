...
| Temporary Rust smoke harness using the exact target-selection block extracted from `main.rs` | Passed: QEMU ARM selects its legacy bound; RPi5, both RISC-V profiles, and an unqualified profile select none |

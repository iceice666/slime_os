...
| Work items | 01a08ff0-0b99-7315-99b0-7e7f340fa6f9, 01a08ff0-0bae-741e-9318-331fdafe0b96 |
...
| `.tasks/items/` | IO10 (epic) and IO11 (milestone, active) with their dependency edges | The lane's identity and state live in the store |
...
- [ ] Only four receive pages are in flight; a burst larger than that between polls is dropped
      by the device and reported in the driver's `stalled` count.

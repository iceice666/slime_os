...
- Raw transcript: [`io-tcp-plane.log`](io-tcp-plane.log), the gate's serial capture and peer summary from the passing run; [`io-tcp-plane-2026-09-12.log`](io-tcp-plane-2026-09-12.log), the same gate after the second review round.

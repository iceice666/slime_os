...
| Problem statements, boundaries, sequencing, invariants, release gates | [`roadmap/`](../roadmap/README.md) — architectural documentation, not the plan |
| Known defects and regressions (open ones come before milestone work) | the `backlog`-tagged items in the store; their problem statements are in [`roadmap/00-backlog.md`](../roadmap/00-backlog.md) |
